...
CREATE TABLE SpotifyClone.Planos(
    ...
    plano VARCHAR(100) UNIQUE NOT NULL,
...
CREATE TABLE SpotifyClone.Artistas(
    ...
    artista VARCHAR(100) UNIQUE NOT NULL
) engine = InnoDB;
...
INSERT INTO SpotifyClone.Artistas_favoritos (usuario_id, artista_id)
VALUES
(1, 1),
(1, 2),
(1, 3),
